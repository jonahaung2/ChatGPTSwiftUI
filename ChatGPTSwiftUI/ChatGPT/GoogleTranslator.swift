...
public class GoogleTranslator {
    ...
    public func translate(text: String, from: NLLanguage, to: NLLanguage, _ format: String = "text", _ model: String = "nmt", _ completion: @escaping ((_ text: String?, _ error: Error?) -> Void)) {
        ...
        queryItems.append(URLQueryItem(name: "target", value: to.rawValue))
        queryItems.append(URLQueryItem(name: "source", value: from.rawValue))
